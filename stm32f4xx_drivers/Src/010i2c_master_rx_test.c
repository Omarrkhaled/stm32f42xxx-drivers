...
int main(void)
{
	...
	while (1)
	{
		...
		I2C_MasterTX(&I2C2_handle, &command_code, 1, SLAVE_ADDR, I2C_SR_ENABLE);

		// read the length information sent from slave TX
		I2C_MasterRX(&I2C2_handle, &len_read, 1, SLAVE_ADDR, I2C_SR_ENABLE);
		...
		// receive the data
		I2C_MasterRX(&I2C2_handle, rcv_buffer, len_read, SLAVE_ADDR, I2C_SR_DISABLE);
